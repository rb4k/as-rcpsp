...
describe "User pages" do
  ...
  describe "index" do
    ...
    it { should have_selector('title', text: 'Alle Mitarbeiter') }
    it { should have_selector('h1', text: 'Alle Mitarbeiter') }
  ...
  describe "edit" do
    ...
    describe "page" do
      it { should have_selector('h1', text: "Aktualisiere Dein Profil") }
      it { should have_selector('title', text: "Profil") }
      it { should have_link('change', href: 'http://gravatar.com/emails') }
    end

    describe "with invalid information" do
      before { click_button "Speichere Änderungen" }
